...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <div class="col-sm-6 col-offset-sm-3">
            <input id="mobileCheckoutAmount" type="text" class="form-control" placeholder="Amount e.g. TAKA 4456">
        </div>
        <p><a class="btn btn-success btn-sm" role="button" id="mobileCheckout">Mobile Checkout</a></p>
        <div class="col-sm-6 col-offset-sm-3">
            <input id="mobileB2CAmount" type="text" class="form-control" placeholder="Amount e.g. TAKA 4456">
        </div>
