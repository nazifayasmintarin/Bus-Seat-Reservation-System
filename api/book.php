<?php
header('Access-Control-Allow-Origin: https://tarin-muriithi.github.io');
...
if (isset($_GET['set_paid'],$_GET['id']) &&  !empty($_GET['id'])){
    ...
    if ($booked){
        ...
        if ($customer->sendMail('muriithitarin556@gmail.com',$customer->generateMessageSendEmail($details))){
            echo json_encode(['success'=>'successfully updated and email sent to tarin']);
            die();
        }
